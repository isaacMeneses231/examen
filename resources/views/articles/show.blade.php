        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700 p-8">
                ...
                <div class="mb-6 grid grid-cols-2 gap-6">
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Código Interno</h3>
                        <p class="text-xl font-mono font-bold text-indigo-600 dark:text-indigo-400">{{ $article->internal_code }}</p>
                    </div>
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Estado de Disponibilidad</h3>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Descripción Detallada</h3>
                ...
                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6 grid grid-cols-2 gap-6 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl">
                    <div>
                        <h3 class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Precio de Venta</h3>
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400">${{ number_format($article->sale_price, 2) }}</p>
                    </div>
                    <div>
                        <h3 class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Costo de Compra</h3>
                        <p class="text-xl font-semibold text-gray-900 dark:text-white">${{ number_format($article->purchase_cost, 2) }}</p>
                    </div>
                </div>

                <div class="mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Fecha de Ingreso al Sistema</h3>
                    <p class="text-md text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($article->entry_date)->format('d/m/Y') }}</p>
                </div>
